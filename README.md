...
| `claude-haiku-4-20250514`  | 가장 빠르고 저렴함, 간단한 리뷰에 적합 |

#### Gemini

| 모델               | 설명                                           |
| ------------------ | ---------------------------------------------- |
| `gemini-2.5-flash` | 기본값. 빠르고 가성비 좋은 모델                |
| `gemini-2.5-pro`   | 더 정교한 분석, 복잡한 코드 리뷰에 적합 (유료) |
| `gemini-3.5-flash` | 최신 모델, 코딩/에이전트 작업에 특화           |
